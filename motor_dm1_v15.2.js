...
async function calculateSportPreparation() {
    ...
    try {
        ...
        REGLA CRÍTICA: Si IOB > 0.5u, DEBE comer al menos 15g. 
        
        FORMATO:
        1. Indica el total de gramos.
        2. Ofrece 3 opciones (Fruta, Galletas o lo que tenga a mano). No te centres SOLO en manzanas. Pregunta qué tiene disponible si hay duda.
        3. Explica el riesgo según el IOB actual.
...
async function calculateSportRecovery() {
    ...
    const kmInt = document.getElementById('sport-km').value;
    ...
    try {
        ...
        - Duración: ${dur} min.
        - Km/Intensidad: ${kmInt}.
        - Glucemia Actual: ${g} mg/dL.
        - IOB Actual: ${iob}.

        TAREA: Analiza la necesidad de recuperación. 
        - Si es MTB Anaeróbico: Advierte sobre la caída retardada por agotamiento de glucógeno y el riesgo hipo post-ejercicio.
        - Calcula CH de absorción lenta (ej: papas frías/arroz) para evitar el "Efecto Esponja" nocturno.
        - Indica gramos sugeridos.
        Sé quirúrgico.`;
